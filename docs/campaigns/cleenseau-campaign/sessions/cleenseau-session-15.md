...
* A number of soldiers from the [Army of the South](<../../../groups/sembaran-army/army-of-the-south.md>) arrive in [Cleenseau](<../../../gazetteer/greater-sembara/sembara/barony-of-aveil/cleenseau-region/cleenseau/cleenseau.md>), and are incorporated into [Ida's](<../../../people/sembarans/ida-rosfeld.md>) growing command

* [Es*tiasilos](<../../../people/pcs/cleenseau/estiasilos.md>) investigates [Enford](<../../../gazetteer/greater-sembara/sembara/western-marches/enford.md>)

* The party trains the local garrison on magical defenses, and [Robin](<../../../people/pcs/cleenseau/robin-of-abenfyrd.md>) holds a ceremony to rally the troops and induct [Odo Cordwaner](<../../../people/sembarans/odo-cordwaner.md>) in the Order of the Charitable Wanderer

* Undead awake, in two groups, and are defeated

* [Gareth of Tollen](<../../../people/sembarans/gareth-of-tollen.md>) is arrested on the road, as an illegal tax collector, and sentenced to death

### Rumors and Information

* The party received two letters from [Rosalind](<../../../people/sembarans/rosalind-essford.md>): [Letter from Rosalind (January 21st)](<../letters-and-other-writings/letter-from-rosalind-january-21st.md>) and [Letter from Rosalind (January 26th)](<../letters-and-other-writings/letter-from-rosalind-january-26th.md>)

* [Es*tiasilos](<../../../people/pcs/cleenseau/estiasilos.md>) scouted [Enford](<../../../gazetteer/greater-sembara/sembara/western-marches/enford.md>), and reported it  tasted sad and angry and chaotic and human

* [Ida Rosfeld](<../../../people/sembarans/ida-rosfeld.md>) received a [Letter from Enford](<../letters-and-other-writings/letter-from-enford.md>)

* The Royal Council has met, and ordered a reorganization of the army, in the Army of the Interior (plus, perhaps, others?), as well as a [war tax](<../../../gazetteer/greater-sembara/sembara/taxes-in-sembara.md#war-taxes>)
...
* [Gareth of Tollen](<../../../people/sembarans/gareth-of-tollen.md>), a villainous tax collector

* [Rene Dubois](<../../../people/sembarans/rene-dubois.md>), a scout of the [Army of the South](<../../../groups/sembaran-army/army-of-the-south.md>)

* [Claire of Fellburn](<../../../people/sembarans/claire-of-fellburn.md>), a sergeant in the [Army of the South](<../../../groups/sembaran-army/army-of-the-south.md>)

* [Bertrand Leclerc](<../../../people/sembarans/bertrand-leclerc.md>), a sergeant in the [Army of the South](<../../../groups/sembaran-army/army-of-the-south.md>)

* [Elizabeth of Cassen](<../../../people/sembarans/elizabeth-of-cassen.md>), an honest tax collector's assistant
...
Then of course we got the band back together by promptly reuniting with our [missing lunatic](<../../../people/pcs/cleenseau/izgil-moonseeker.md>), who we encountered on the road between [Dallet](<../../../gazetteer/greater-sembara/sembara/barony-of-aveil/dallet.md>) and [Beury](<../../../gazetteer/greater-sembara/sembara/barony-of-aveil/cleenseau-region/beury.md>). He and [The Rangers](<../../../groups/the-rangers.md>) - [Vahaiya](<../../../people/elves/vahaiya.md>), [Tristan](<../../../people/sembarans/tristan-vaudrillard.md>), and [Remille](<../../../people/sembarans/remille-vauclaire.md>) had been clearing out undead dregs in the [East Bog](<../../../gazetteer/greater-sembara/sembara/barony-of-aveil/cleenseau-region/east-bog.md>).  After a brief reunion, Tristan and Remille, along with [Emilie](<../../../people/sembarans/emilie.md>), now reunited with her companions, head north toward the Aveil Hills in order to figure out what had happened to their friends - [Damien Montrichard](<../../../people/sembarans/damien-montrichard.md>), [Enzo Brightwood](<../../../people/halflings/enzo-brightwood.md>) and [Adra Brightwood](<../../../people/halflings/adra-brightwood.md>); [Vahaiya](<../../../people/elves/vahaiya.md>) remained, because they was concerned about the fey-realm portal we had previously discovered. So a bunch of them went one way, and they went to keep watch over the portal and see if there was a pattern to it doing anything, and we all went to figure out what nonsense had happened in our absence.  
...
As we were dealing with petty grievances and generalized nonsense, we started getting news from [Embry](<../../../gazetteer/greater-sembara/sembara/heartlands/embry.md>). None of which was great! Because yes, sure, a tax levy to deal with this whole situation is reasonable, but the part where the scrambled army orders is being blamed on the people who were trying to follow them not so much, and definitely blaming the [Duke](<../../../people/sembarans/jacques-bellemont.md>) for how things were handled in [Wisford](<../../../gazetteer/greater-sembara/sembara/heartlands/duchy-of-wisford.md>) when he only managed to deal with the problem basically by mutiny because he was being sabotaged every which way was not on. Also the undead rising problem was blamed on some necromancers who had infiltrated the Night Queen temple, several senior priests had been put to death, and several were wanted for question - particularly including [Lenora Belles](<../../../people/sembarans/lenora-belles.md>) and [Raoul Boulain](<../../../people/sembarans/raoul-boulain.md>), the cleric who had set up the 'destroys all the undead' thing. We are cross. We send a letter to [Rosalind](<../../../people/sembarans/rosalind-essford.md>), and another to [Susanne Garay](<../../../people/sembarans/susanne-garay.md>).

The whole thing appears to be set up to neutralize anyone who has been effective about the problems. The party is (at least currently) outside of the relevant hierarchies which means the problem in the court - we theorize some powerful warlock of the Gloomshaper, an enemy of the fey queen of [Tyrwingha](<../../../gazetteer/greater-sembara/tyrwingha/tyrwingha.md>), where Celyn and Robin are from, who has claimed this area, apparently - cannot use that sort of order-giving to mess with us. Messing with us will have to be more direct.  
...
The rumors about the necromancers came with the warning that apparently the ritual they did was supposed to raise the dead every new moon, so we spent the week or so remaining before that training our local troops to deal with magical combat situations, monsters, and the like, using illusions and no-damage magic. It seemed the thing to do. Izgil talked to [Brot](<../../../people/dwarves/brot-starsearcher.md>) and [Diesla Starsearcher](<../../../people/dwarves/diesla-starsearcher.md>), who were working on siege engines - and who really would rather be working on telescopes - about finding a compromise position and working on constructing solar mirror weapons ala Greek ship-destroyers.  
...
[Rene](<../../../people/sembarans/rene-dubois.md>): Fey? But we weren't in Tyrwingha.  
...
It turns out the tax collector is not following the [protocols](<../../../gazetteer/greater-sembara/sembara/taxes-in-sembara.md>). (There is a set amount he is supposed to collect, and he's trying to get more than that; there are set people and procedures for this, and he's basically trying to extort cash from randos on the road. Randos on the road include the party.)  

It also turns out that the tax collector is someone Viepuck recognizes ... from the whole orphan-murdering ring at the [Lord Mayor’s Workhouse](<../../../gazetteer/greater-sembara/sembara/heartlands/lord-mayors-workhouse.md>). Viepuck, used his [Circlet of Telepathy](<../treasure/circlet-of-telepathy.md>) to inform the party, "He's evil!" each in turn, just before the guy starts trying to do a shakedown on the group, starting with Robin.  
...
[Gareth of Tollen](<../../../people/sembarans/gareth-of-tollen.md>): Are you resident here?  

Robin, coldly: I am Sir Robin of the _Order of the Charitable Wanderer_ I am not _resident_ **anywhere**.  

[Gareth of Tollen](<../../../people/sembarans/gareth-of-tollen.md>): But surely you wish to contribute to the common defense?  
...
In any case, we apprehend the apparent crooks, get the help of the honest guards, and head back to [Cleenseau](<../../../gazetteer/greater-sembara/sembara/barony-of-aveil/cleenseau-region/cleenseau/cleenseau.md>) to figure out what the fuck to do with them. Which, after a trial, turns out to be 'execute the ringleader and his buddy, get the other two bandits who weren't in on it and one of whom turned state's evidence if only under the influence of magic to join the local army, and return the money to the [Erick Murtha](<../../../people/sembarans/erick-murtha.md>) who is confused until we explain that we want to make sure he has cash for the legitimate tax collector.