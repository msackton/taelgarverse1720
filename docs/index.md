...
You most likely want to start with the [NPCs](<campaigns/cleenseau-campaign/people-of-cleenseau.md>), session notes, and other information about the [Cleenseau Campaign](<campaigns/cleenseau-campaign/cleenseau-campaign.md>). Then you might want to read about [Sembara](<gazetteer/greater-sembara/sembara/sembara.md>) and [Tyrwingha](<gazetteer/greater-sembara/tyrwingha/tyrwingha.md>), two of the major realms. Or you might want to read about the religion of [Mos Numena](<cosmology/religions/mos-numena/mos-numena.md>) or just explore the [Gazetteer](<gazetteer/gazetteer.md>). 
